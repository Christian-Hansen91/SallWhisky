...
public class App {
    ...
    private static void initStorage() {
        ...
        Destillering destillering1 = Controller.opretDestillering(01, LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 2), 10.0, 22.0, 100.0, 28.0, "OK", 52.5);
        Destillering destillering2 = Controller.opretDestillering(02, LocalDate.of(2024, 4, 16), LocalDate.of(2024, 4, 16), 30.0, 8.0, 100.0, 25.0, "OBS, tåler fortynding", 59.9);
